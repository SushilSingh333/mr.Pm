...
export const SOCIALS = [
  ...
  { label: 'Instagram', icon: 'instagram', href: 'https://www.instagram.com/mrmoverpacker/' },
  {
    label: 'YouTube',
    icon: 'youtube',
    href: 'https://www.youtube.com/channel/UCGpnAoxGc0Hw6R7ksRj7Icg',
  },
  { label: 'X', icon: 'x', href: 'https://x.com/mrmoverpacker' },
  { label: 'Reddit', icon: 'reddit', href: 'https://www.reddit.com/user/mrmover_packer/' },
  { label: 'Quora', icon: 'quora', href: 'https://www.quora.com/profile/Mrmoverpacker' },
  { label: 'Threads', icon: 'threads', href: 'https://www.threads.com/@mrmoverpacker' },
  { label: 'Pinterest', icon: 'pinterest', href: 'https://in.pinterest.com/mrmoverpacker/' },
];
